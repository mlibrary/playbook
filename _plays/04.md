...
2. Run usability tests frequently to see how well the service works and identify improvements that should be made; debrief usability sessions with the project team (routinely show the project team examples of user behavior with key tasks)
...
- What are the key user/usability/accessibility research, UX/UI design, development objectives for each iteraction/sprint?
- Which version control system is being used?
- How are bugs tracked and tickets issued? What tool is used?
- How are accessibility issues reported and tracked?
